    ...
    <>
      ...
      <div className="about-page">
        ...
        <section className="about-content">
          ...
          <p>
            Recipe Finder is a smart platform designed to help you create
            amazing meals using the ingredients you already have or explore our
            wide selection of ready-made recipes. Whether you're trying to
            minimize food waste, discover new dishes, or simply find a recipe
            for a specific category, Recipe Finder has you covered.
          </p>

          <h2>How Does It Work?</h2>
          <ul>
            <li>
              <strong>Input Your Ingredients:</strong> Simply list the
              ingredients you have on hand, and we'll suggest recipes you can
              make.
            </li>
            <li>
              <strong>Explore Categories:</strong> Browse through our curated
              recipe categories, such as Appetizers, Desserts, or Quick Meals,
              to find ready-to-cook dishes.
            </li>
            <li>
              <strong>AI-Powered Suggestions:</strong> Let our advanced
              algorithm generate creative and delicious recipes tailored to your
              inputs.
            </li>
            <li>
        ...
        <section className="about-features">
          ...
          <div className="features-list">
            ...
            <div className="feature">
              ...
              <p>
                Follow easy, detailed steps to cook delicious meals
                effortlessly.
              </p>
            </div>
            <div className="feature">
